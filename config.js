...
const CONFIG = {
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Bunene Construction Pty ltd — Pool services in johannesburg",
    description: "Bunene Construction Pty ltd provides professional pool services in Johannesburg. 4 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Bunene Construction Pty ltd keeps swimming pools clean, chemically balanced and fully functional across Johannesburg. Maintenance, repairs, pump and filter work — we handle it all.",
    ...
    band: {
      ...
      alt:   "Bunene Construction Pty ltd team at work in Johannesburg",
